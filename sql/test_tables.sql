...
INSERT INTO test_names (test_type, name)
VALUES ('light_reaction', 'Реакция на свет'),
...
CREATE INDEX IF NOT EXISTS idx_invitation_tests_invitation_id ON invitation_tests (invitation_id);
CREATE INDEX IF NOT EXISTS idx_test_invitations_user_id ON test_invitations (user_id);
CREATE INDEX IF NOT EXISTS idx_test_invitations_completed ON test_invitations (is_completed);
