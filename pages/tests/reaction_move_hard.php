...
<head>
    ...
    <style>
        ...
        #square1 {
            ...
            width: 75px;
            height: 75px;
            border: 2px solid black; /* Добавляем черную границу */
            border-radius: 5px;
            left: 5%;
            background-color: red;
            color: white;
...
<div id="menu" class="modal">
    <div class="modal-content">
        ...
        <h2>Нажмите 1, чтобы остановить верхний квадрат <br> Нажмите 2, чтобы остановить средний квадрат <br> Нажмите 3, чтобы остановить нижний квадрат <br> Введите время выполнения теста:</h2>
...
<script type='module' src="../../scripts/tests/reaction_move_hard.js"></script>
</body>
</html>