...
<form class="mb-3" method="get">
    <div class="input-group">
        <input type="text" name="search" class="form-control" placeholder="Поиск по имени пользователя" value="<?php echo htmlspecialchars($search ?? ''); ?>">
                    ...
                    <ul class="list-group list-group-flush">
                        <?php foreach ($users as $u): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <a href="?user_id=<?php echo $u['id']; ?>" class="btn btn-primary btn-sm">Просмотреть</a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
        ...
        <?php else: ?>
            <div class="alert alert-info">Нет зарегистрированных пользователей.</div>
        <?php endif; ?>
    </div>
    <?php
...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <a href="expert_results.php" class="btn btn-primary">&larr; К списку пользователей</a>
        <h1 class="mb-0">Результаты <?php echo htmlspecialchars($user['name']); ?></h1>
    ...
    <form class="mb-4" method="get">
        ...
        <div class="row g-2">
            ...
            <div class="col-auto d-flex align-items-end">
                <a href="?user_id=<?php echo $userId;?>" class="btn btn-outline-secondary">Сбросить фильтр</a>
            </div>
            <?php endif; ?>
        </div>
    </form>
    ...
    <?php if ($testType && count($graphData)>=2): ?>
      <div class="card mb-4 shadow-sm">
        <div class="card-body">
          <h5 class="card-title">Графики для «<?php echo $labels[$testType]; ?>»</h5>
        ...
        <div class="card-body p-0 table-responsive">
          <table class="table table-hover mb-0">
            <thead class="table-light">
              <tr>
                <th>#</th><th>Тип теста</th><th>Среднее время</th><th>Точность</th><th>Дата</th>
              </tr>
            </thead>
            <tbody>
    ...
    <?php else: ?>
      <div class="alert alert-info">У этого пользователя нет результатов тестов.</div>
    <?php endif; ?>
</div>
